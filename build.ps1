...
if(-Not $SkipToolPackageRestore.IsPresent)
{
    ...
    {
        $NuGetOutput = Invoke-Expression "&`"$NUGET_EXE`" install Cake -Version 0.35.0 -ExcludeVersion" # Pin Cake version to 0.25.0; see https://github.com/App-vNext/Polly/issues/416 
        Write-Verbose ($NuGetOutput | Out-String)
    }
    Pop-Location
